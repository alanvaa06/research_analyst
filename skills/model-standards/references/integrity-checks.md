...
| F15 | **Series sin huecos** (S5 hecho código) | Fila con contenido en ≥ la mitad de las columnas de periodo pero con celdas VACÍAS = fórmula faltante en un tramo (la NOPAT vacía en forecast del smoke #4 que convirtió el FCFF en chatarra y el equity en $96). Bloques de valor único (una columna) no disparan; `n/a` cuenta como contenido deliberado. Detección de columnas de periodo reconoce años A/E Y trimestres de texto (punto ciego corregido de F11/F12) |
